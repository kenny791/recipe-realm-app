			...
			<div>
				<div id="carouselExample" className="carousel slide mt-5">
					<div className="carousel-inner">
						<Link className="carousel-link" to="/search" onClick={handleClick("erythroxylum")}>
						...
						<Link className="carousel-link" to="/search" onClick={handleClick("alectoria")}>
						...
						<Link className="carousel-link" to="/search" onClick={handleClick("nemacladus")}>
							<div className="carousel-item ">
