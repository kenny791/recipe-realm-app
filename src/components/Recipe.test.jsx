...
describe('Recipe Page', () => {
  ...
  it('Loads the Recipe does not exist module', () => {
    const noRecipeDiv = container.querySelector('div')
    const noRecipeWarningText = noRecipeDiv.querySelector('h3')
    expect(noRecipeDiv).toBeDefined()
    expect(noRecipeWarningText).toBeDefined()
    expect(noRecipeWarningText).toHaveTextContent('This recipe does not exist')
  })
})